  ...
  return (
    ...
    <div className="min-h-screen relative">      
      ...
      {!isAccountCreated ? (
        ...
        <ResizablePanels
          leftPanel={
            <div className="bg-arch-black p-6 rounded-lg h-full">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-arch-gray text-arch-white rounded-md focus:outline-none focus:ring-2 focus:ring-arch-orange mb-2 min-h-[100px]"
                required
              />
              <button 
              ...
              <div className="space-y-4 max-h-[500px] overflow-y-auto">
                {[...wallData].reverse().map((item, index) => (
                  <div key={index} className="bg-arch-gray p-3 rounded-lg">
                    ...
                    <p className="text-arch-white break-words">
